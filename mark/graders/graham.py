...
from mark.grader import Grader, iterable_grading, point_grading
from mark.markdata import MarkData, StageMarkData, Mistake
from functools import partial


point025 = partial(point_grading, sub=0.25)
...
class GrahamGrader(Grader):
    ...
    stage_grading_methods = [point025, ordered_grading, point025, steps_table_grading]
